const SignIn = () => {
    ...
    return ( 
        <div className=" border h-screen bg-blue-50 shadow-black">
        <div className="flex flex-col items-center justify-center mt-15 gap-9 font-serif " >
            <div className="border-2 shadow-2xl  bg-blue-100 mt-15 rounded-2xl flex flex-col justify-evenly items-center h-[60%] w-[25%] gap-1.5">
                ...
                <form>
                    <div className="w-[100%]  pt-5">
                        ...
                        <input type="email" placeholder="Enter your Email" className="border-1 rounded-xl pl-2 w-full p-2 focus:outline-none focus:border-blue-700" />
                    </div>
                    <div className="w-[100%]  pt-5 ">
                    ...
                    <div className="mt-3 p-4 ">
                        <p >Don't have an account? <span className="text-blue-950 hover:cursor-pointer hover:text-red-600">Create one here</span></p>
                    </div>
